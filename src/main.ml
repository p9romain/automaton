...
let regexp = R.(
  union
    (union 
      (concat 
          (concat (letter "a") (letter "a")) 
          (concat (letter "b") (letter "a"))
      ) 
      (concat 
        (concat (letter "a") (letter "a")) 
        (letter "a")
...
let () = Printf.printf "Regexp : %s\n" @@ R.(to_string @@ simp_to_ext regexp)
let () = Printf.printf "Regexp simplified : %s\n" @@ R.(to_string @@ simplify @@ simp_to_ext regexp)
